...
// Define paths
const scriptPath = path.join(process.cwd(), "scripts", "csv-processors", "process-security-and-compliance.ts")
...
log(`Testing security and compliance processor script at: ${scriptPath}`, "info")
