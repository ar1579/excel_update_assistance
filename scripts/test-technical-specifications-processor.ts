...
// Define paths
const scriptPath = path.join(process.cwd(), "scripts", "csv-processors", "process-technical-specifications.ts")
...
log(`Testing technical specifications processor script at: ${scriptPath}`, "info")
